"""Build the second-joint manifest with post target percentile/gamma of first-joint object."""
...
DEFAULT_PREFIX = "secondjoint_postobjraw_pg_p0p1_p99p9_g1p5_4d_size256_three_images_rms020_030_040_pre400_joint1000x2_20260612"
IMAGES = ["Iksung_beads", "dendrites", "dendrites_dense"]
RMS_VALUES = [0.20, 0.30, 0.40]
METHOD = "scalar5_second_joint_postobjraw_pg_p0p1_p99p9_g1p5"
...
def settings() -> list[dict[str, Any]]:
    label = "scalar=5 first joint + post-joint object p0.1/p99.9 gamma=1.5"
    return [
        {
            "method": METHOD,
            ...
            "joint_variant": "second_joint_postobjraw_percentile_gamma",
            "label": label,
            "method_label": label,
            "pretrain_scalar": 5.0,

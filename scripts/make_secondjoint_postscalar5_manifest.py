"""Build the scalar5 second-joint + post-joint scalar pretrain manifest."""
...
DEFAULT_PREFIX = "secondjoint_postscalar5_4d_size256_three_images_rms020_030_040_pre400_joint1000x2_20260612"
IMAGES = ["Iksung_beads", "dendrites", "dendrites_dense"]
RMS_VALUES = [0.20, 0.30, 0.40]
METHOD = "scalar5_second_joint_postscalar5"
...
def settings() -> list[dict[str, Any]]:
    label = "scalar=5 second joint + post-joint scalar5 pretrain"
    return [
        {
            "method": METHOD,
            ...
            "joint_variant": "second_joint_postscalar5",
            "label": label,
            "method_label": label,
            "pretrain_scalar": 5.0,
